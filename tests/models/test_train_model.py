...
def test_product():
    # Load file
    df_wine_train_data = pd.read_parquet("data/processed/df_wine_train_data.parquet")
    df_wine_train_target = pd.read_parquet("data/processed/df_wine_train_target.parquet")
    df_wine_test_data = pd.read_parquet("data/processed/df_wine_test_data.parquet")
    df_wine_test_target = pd.read_parquet("data/processed/df_wine_test_target.parquet")
    df_pred_train = pd.read_parquet("data/processed/df_pred_train.parquet")
    df_pred_test = pd.read_parquet("data/processed/df_pred_test.parquet")
    ...
    assert len(df_pred_test) == len(df_wine_train_data)
